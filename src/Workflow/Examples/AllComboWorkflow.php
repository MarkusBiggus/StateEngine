...
class AllComboWorkflow extends Workflow implements WorkflowContract
{
    /**
    ...
    'StateTransitions' => [
        'S1' => [
            ...
            ['Transition' => 'T1_4', 'TargetStates' => ['S4']],
            ['Transition' => 'T1_SM', 'TargetStates' => ['S5','S6','S7']],
        ],
        'S2' => [
            ['Transition' => 'T1_SM', 'TargetStates' => ['S6']],
        ],
        'S3' => [
            ['Transition' => 'T3_6', 'TargetStates' => ['S4']],
        ],
        'S4' => [
        ],
        'S5' => [
    ...
    */
     ...
     * Unique OriginState
     * Split will be inferred from multiple targets when not defined
     */
    'Splits' => [
            ['OriginState' => 'S1', 'Transition' => ['T1_SM']],
        ],
    /**
     * Hints for Fork tell the Engine to expect
     *  multipe transitions to occur before new States are active.
     * Transition to multiple states from multiple events
     *  from single state.
     * Unique Transitions collection
     * All transitions must be emitted for the target states
     *  to be executed.
     */
    'Forks' => [
            ['OriginState' => 'S1', 'Transitions' => ['T1_4','T1_SM']],
        ],
    /**
