...
class MergeComboWorkflow extends Workflow implements WorkflowContract
{
    /**
    ...
    'StateTransitions' => [
        'S1' => [
            ['Transition' => 'T1_2_3_4_5', 'TargetStates' => ['S2','S3','S4','S5']],
        ],
        'S2' => [
        ...
        'S3' => [
            ['Transition' => 'T2_3_6', 'TargetStates' => ['S6']],
            ['Transition' => 'T3_3a',  'TargetStates' => ['S3a']],
        ],
        'S3a' => [
            ['Transition' => 'T2_3_6', 'autoTransition' => false, 'TargetStates' => ['S6']],
        ],
        'S4' => [
            ['Transition' => 'T4_5_6', 'autoTransition' => false, 'TargetStates' => ['S6']],
        ],
        'S5' => [
            ['Transition' => 'T4_5_6', 'autoTransition' => false, 'TargetStates' => ['S6']],
        ],
    ...
    */
    ...
    'Splits' => [
            ['OriginState' => 'S1', 'Transition' => ['T1_2_3_4_5']],
        ],
    'Forks' => [
        ],
    /**
     ...
     */
    'Syncs' => [
            ['TargetState' => 'S6', 'Transitions' => ['T2_3_6', 'T4_5_6']], // Sync: Merges
        ],
    /**
    ...
    'Merges' => [
           ...
           ['TargetState' => 'S6', 'Transition' => ['T4_5_6']],
        ],
    /**
