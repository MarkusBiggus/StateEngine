...
class MultiSyncWorkflow extends Workflow implements WorkflowContract
{
    /**
    ...
    'StateTransitions' => [
        'S1' => [
            ...
            ['Transition' => 'T1_4_5', 'TargetStates' => ['S4','S5']],
            ['Transition' => 'T1_2_5', 'TargetStates' => ['S2','S5']],
        ],
        'S2' => [
            ['Transition' => 'T2_6', 'TargetStates' => ['S6']],
        ],
        'S3' => [
            ['Transition' => 'T3_6', 'TargetStates' => ['S6']],
        ],
        'S4' => [
            ['Transition' => 'T4_6', 'TargetStates' => ['S6']],
        ],
        'S5' => [
    ...
    */
    ...
    'Splits' => [
            ...
            ['OriginState' => 'S1', 'Transition' => ['T1_4_5']],
    // this one be inferred        ['OriginState' => 'S1', 'Transition' => ['T1_2_5']],
        ],
    'Forks' => [
        ],
    /**
     ...
     */
    'Syncs' => [
            ['TargetState' => 'S6', 'Transitions' => ['T2_6', 'T5_6']],
            ['TargetState' => 'S6', 'Transitions' => ['T3_6', 'T4_6']],
        ],
    /**
