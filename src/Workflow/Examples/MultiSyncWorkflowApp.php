 ...
 */
class MultiSyncWorkflowApp extends WorkflowApp implements WorkflowAppContract
{
    /**
     * StatePath
     *
    ...
    public function InitAppContext(array $params): ?WorkflowAppContract
    {
         ...
         * States after S1 emit their default transition
         *
         *       multi: I->S1->S2->S3->S4->S5->S6
         * multistall : stalls
         */
        $this->TestSEQTransitions = [
            'S1' => [
                'multi'   => ['T1_2_5', '', 'T1_4_5'],
                'multistall'   => ['T1_2_3','T1_4_5'],
            ],
        ];
        return $this ;
    }
